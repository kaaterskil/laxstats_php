	...
	while(!$games_obj->eof){
		while($row < $rows){
			...
			while($column < 2){
				if($game < $games){
					//1. get data
					$gameRef			= $games_obj->field['gameRef'];
					$date				= $games_obj->field['date'];
					$fieldRef			= $games_obj->field['fieldRef'];
					$seasonType			= $games_obj->field['seasonType'];
					$field				= $games_obj->field['field'];
					$home_team			= $games_obj->field['home_team'];
					$home_abbrev		= $games_obj->field['home_abbrev'];
					$home_tr			= $games_obj->field['home_tr'];
					$home_tmr			= $games_obj->field['home_tmr'];
					$visitor_team		= $games_obj->field['visitor_team'];
					$visitor_abbrev		= $games_obj->field['visitor_abbrev'];
					$visitor_tr			= $games_obj->field['visitor_tr'];
					$visitor_tmr		= $games_obj->field['visitor_tmr'];
					$home_score			= $games_obj->field['home_score'];
					$home_shots			= $shots_obj->field['home_shots'];
					$home_goalsQ1		= $games_obj->field['home_goalsQ1'];
					$home_goalsQ2		= $games_obj->field['home_goalsQ2'];
					$home_goalsQ3		= $games_obj->field['home_goalsQ3'];
					$home_goalsQ4		= $games_obj->field['home_goalsQ4'];
					$home_goalsOT		= ($games_obj->field['home_goalsOT'] > 0 ? $games_obj->field['home_goalsOT'] : '-');
					$visitor_score		= $games_obj->field['visitor_score'];
					$visitor_shots		= $shots_obj->field['visitor_shots'];
					$visitor_goalsQ1	= $games_obj->field['visitor_goalsQ1'];
					$visitor_goalsQ2	= $games_obj->field['visitor_goalsQ2'];
					$visitor_goalsQ3	= $games_obj->field['visitor_goalsQ3'];
					$visitor_goalsQ4	= $games_obj->field['visitor_goalsQ4'];
					$visitor_goalsOT	= ($games_obj->field['visitor_goalsOT'] > 0 ? $games_obj->field['visitor_goalsOT'] : '-');
					//2. process data
